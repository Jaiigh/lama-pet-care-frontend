...
import { ClipboardList, Users, LogOut, type LucideIcon } from "lucide-react";
      ...
      <aside className="sticky top-0 h-screen w-64 shrink-0 border-r border-emerald-100 bg-white">
        ...
        <div className="px-4 py-6">
          <button
            ...
            className="group flex w-full items-center gap-3 rounded-xl px-3 py-2 text-sm font-medium text-slate-600 hover:bg-emerald-50 hover:text-emerald-700"
          >
            <span className="h-5 w-1 rounded-full bg-transparent group-hover:bg-emerald-200" />
