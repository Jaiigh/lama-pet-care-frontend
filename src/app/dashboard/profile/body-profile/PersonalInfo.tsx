...
function PersonalInfo() {
  ...
  const info_items = [
    { id: 1, key: "name", label: "ชื่อนามสกุล", value: profile?.name || "loading..." },
    { id: 2, key: "id", label: "เลขประจำตัวผู้ใช้", value: profile?.id || "loading..." },
    { id: 3, key: "tel", label: "หมายเลขโทรศัพท์", value: profile?.tel || "loading..." },
    { id: 4, key: "email", label: "อีเมล", value: profile?.email || "loading..." },
    { id: 5, key: "createdAt", label: "วันที่สมัครสมาชิก", value: profile?.createdAt || "loading..." },
    { id: 6, key: "birthDate", label: "วันเกิด", value: profile?.birthDate || "loading..." },
    { id: 7, key: "address", label: "ที่อยู่", value: profile?.address || "loading..." },
  ];
            ...
            <div key={item.id} className="px-5 text-[#072568] flex-1 basis-[45%]">
              ...
              {isEditing ? (
                <input
                  ...
                  onChange={(e) => handleChange(item.key as keyof Profile, e.target.value)}
                />
              ) : (
