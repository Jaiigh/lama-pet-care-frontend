...
const BookFullDayPageInner = () => {
  ...
  const [PAYMENT_REDIRECT_URL, setPAYMENT_REDIRECT_URL] =
    useState("this/auth/login");
  ...
  const handleSubmit = async () => {
    ...
    const payload: CreateBookingPayload = {
      ...
      pet_id: selectedPet,
      reserve_date_end: `${effectiveEnd} ${endTime}`,
      reserve_date_start: `${effectiveStart} ${startTime}`,
